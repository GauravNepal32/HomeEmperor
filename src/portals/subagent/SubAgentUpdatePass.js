...
const SubAgentUpdatePass = ({showErrorToastMessage,showToastMessage,userToken}) => {
    ...
    const [invalidPass, setInvalidPass] = useState(false);
     const changePassURL =
         "https://heuristic-wescoff.128-199-28-111.plesk.page/panel/api/change-password";
...
export default SubAgentUpdatePass;